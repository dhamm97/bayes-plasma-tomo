...
def reg_param_tuning_train_phantoms(sigma_level, phantom_dir, saving_dir):
    ...
    # load forward model
    fwd_model = sp.load_npz('../../tomo_fusion/forward_model/geometry_matrices/sparse_geometry_matrix_sxr_fine_grid.npz')
...
if __name__ == '__main__':
    ...
    saving_dir = 'hyperparam_tuning/reg_param_tuning_fine_anisotropic_newbounds_sigma005005/'
